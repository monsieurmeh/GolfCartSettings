...
namespace GolfCartSettings
{
    ...
    internal static class GolfCartControllerSettingsPatch
    {
        ...
        private static void ReportValues(GolfCartControllerDefinition __instance)
        {
            ...
            Console.WriteLine($"AudioAccelerationMin: {__instance.AudioAccelerationMin}");
            Console.WriteLine($"AudioAccelerationMax: {__instance.AudioAccelerationMax}");
            Console.WriteLine($"AudioBrakingMin: {__instance.AudioBrakingMin}");
            Console.WriteLine($"AudioBrakingMax: {__instance.AudioBrakingMax}");
            Console.WriteLine($"AudioSpeedMin: {__instance.AudioSpeedMin}");
            Console.WriteLine($"AudioSpeedMax: {__instance.AudioSpeedMax}");
            Console.WriteLine($"AudioBeepMinTime: {__instance.AudioBeepMinTime}");
            Console.WriteLine($"EngineLoadRpmThreshold: {__instance.EngineLoadRpmThreshold}");
            Console.WriteLine($"WheelAudioWaterLevel: {__instance.WheelAudioWaterLevel}");
            Console.WriteLine($"AudioTractionSmoothDownFactor: {__instance.AudioTractionSmoothDownFactor}");
            Console.WriteLine($"AudioTractionSmoothUpFactor: {__instance.AudioTractionSmoothUpFactor}");
            Console.WriteLine($"DeepWaterLevel: {__instance.DeepWaterLevel}");
            Console.WriteLine($"DeepWaterThresholdIncreaseRate: {__instance.DeepWaterThresholdIncreaseRate}");
        ...
        private static void SetValues(GolfCartControllerDefinition __instance)
        {
            ...
            __instance.AudioAccelerationMin = Config.AudioAccelerationMin.Value;
            __instance.AudioAccelerationMax = Config.AudioAccelerationMax.Value;
            __instance.AudioBrakingMin = Config.AudioBrakingMin.Value;
            __instance.AudioBrakingMax = Config.AudioBrakingMax.Value;
            __instance.AudioSpeedMin = Config.AudioSpeedMin.Value;
            __instance.AudioSpeedMax = Config.AudioSpeedMax.Value;
            __instance.AudioBeepMinTime = Config.AudioBeepMinTime.Value;
            __instance.EngineLoadRpmThreshold = Config.EngineLoadRpmThreshold.Value;
            __instance.WheelAudioWaterLevel = Config.WheelAudioWaterLevel.Value;
            __instance.AudioTractionSmoothDownFactor = Config.AudioTractionSmoothDownFactor.Value;
            __instance.AudioTractionSmoothUpFactor = Config.AudioTractionSmoothUpFactor.Value;
            __instance.DeepWaterLevel = Config.DeepWaterLevel.Value;
            __instance.DeepWaterThresholdIncreaseRate = Config.DeepWaterThresholdIncreaseRate.Value;
